...
namespace StandingDeskControlPanel.ViewModel
{
    /// <summary>
    ...
    /// </summary>
    public struct VoiceCommandData
    {
        ...
        public VoiceCommandData(string voiceCommand, string commandMode, string textSpoken, string destination)
        {
